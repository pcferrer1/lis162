<div>
    ...
    {{-- <h1>Show Page Livewire</h1>
        <ul>
            <li>Title: {{ $rec->title }}</li>
            <li>Author: {{ $rec->author }}</li>
            <li>Category: {{ $rec->subject }}</li>
            <li>Content: {{ $rec->content }}</li>
            <li>Date: {{ $rec->created_at->format('m/d/Y') }}</li> --}}
    ...
    <div class="container w-full md:max-w-3xl mx-auto pt-20">
        ...
        <div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal" style="font-family:Georgia,serif;">
            ...
            <!--Title-->
            <div class="font-sans">
                <p class="text-base md:text-sm text-green-500 font-bold">&lt; <a href="{{ URL::previous() }}" class="text-base md:text-sm text-green-500 font-bold no-underline hover:underline">Go Back</a></p>
                        <h1 class="font-bold font-sans break-normal text-gray-900 pt-6 pb-2 text-3xl md:text-4xl">{{ $rec->title }}</h1>
                        <p class="pt-2 text-sm md:text-base font-normal text-gray-600">
                            <span class="inline-block pr-3">
                                <img class="w-10 inline-block h-10 rounded-full mr-1" src="http://i.pravatar.cc/300" alt="Avatar of Author">
                                <span class="text-grey-900 font-semibold">{{ $rec->author }}</span>
                            </span>  
                            <span class="text-sm font-serif font-normal text-grey-900">{{ $rec->created_at->format('M d, Y') }}</span></p>
            </div>
        ...
        <div class="flex w-full items-center font-sans px-4 py-12">
            ...
            <div class="flex-1 px-2">
                <p class="text-base font-bold text-base md:text-xl leading-none mb-2">{{ $rec->author }}</p>
                <p class="text-gray-900 text-xs md:text-base">Chess Blog</a></p>
            </div>
        ...
        <div class="font-sans flex justify-between content-center px-4 pb-12">
            <div class="text-left">
                ...
                <p><a href="#" class="break-normal text-base md:text-sm text-green-500 font-bold no-underline hover:underline">< Previous Post</a></p>
            </div>
            <div class="text-right">
                {{-- <span class="text-xs md:text-sm font-normal text-gray-600">Next Post &gt;</span><br> --}}
                <p><a href="#" class="break-normal text-base md:text-sm text-green-500 font-bold no-underline hover:underline">Next Post ></a></p>
            </div>
        </div>
