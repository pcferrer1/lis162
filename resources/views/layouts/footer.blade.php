    ...
    <footer class="bg-white dark:bg-gray-800 border-t border-gray-200 shadow">
        <div class="container px-6 py-4 mx-auto">
            <div class="lg:flex">
                <div class="w-full -mx-6 lg:w-2/5">
                    <div class="px-6">
                        <div>
                            <a href="#" class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">UPChess</a>
                        </div>
                ...
                <div class="mt-6 lg:mt-0 lg:flex-1">
                    <div class="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                        ...
                        <div>
                            ...
                            <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">upchessteam@gmail.com</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <p class="text-center text-gray-800 dark:text-white">© UPChess {{ date('Y') }} - All rights reserved</p>
            </div>
        </div>
    </footer>