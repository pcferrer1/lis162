<x-app-layout>
    ...
    <div class="flex gap-2 min:h-full bg-green-300 min-h-full">

        <div class="bg-blue-500 text-white flex-auto">Text 1</div>
        <div class="bg-red-500 text-white">Text 2</div>
        <div class="bg-yellow-500 text-white">Text 3</div>
